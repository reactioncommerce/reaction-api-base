...
export default {
  ...
  48: {
    ...
    longText: 'MongoDB exited because its port was closed, or was already taken by a previous instance of MongoDB'
  },
  100: {
    code: 100,
    ...
    longText: 'MongoDB had an unspecified uncaught exception.\n' +
      ...
      `Check that you have permissions to write to the database path. MongoDB does\n` +
